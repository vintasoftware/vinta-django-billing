...
from billing.services.payment_adapters.stripe_payment_adapter import (
...
@patch("billing.services.payment_adapters.stripe_payment_adapter.stripe.PaymentIntent")
...
@patch("billing.services.payment_adapters.stripe_payment_adapter.logger")
@patch("billing.services.payment_adapters.stripe_payment_adapter.stripe.PaymentIntent")
...
@patch("billing.services.payment_adapters.stripe_payment_adapter.stripe.Refund")
