...
if TYPE_CHECKING:
    from billing.counting import UsageContext
...
class Registry(Generic[DefinitionT]):
    ...
    def _unknown(self, key: str) -> ImproperlyConfigured:
        return ImproperlyConfigured(
            ...
            "import time -- see billing.registry."
    ...
    def clear(self) -> None:
        """Empty the registry. For tests; see :func:`billing.testing.registered`."""
...
class ResourceRegistry(Registry[ResourceDefinition]):
    ...
    def register(
        ...
        *,
        ...
        ``kind`` is a :class:`billing.constants.LimitKind` -- whether the
        resource is capped up front or metered and billed afterwards. ``remedy``
        is the :class:`billing.constants.LimitRemedy` the over-limit error tells
