...
from billing.recipients import get_billing_recipients
from billing.services.billing_state_machine import transition_billing_state
from billing.signals import billing_restriction_lifted
...
class DunningService:
    ...
    def __init__(
        ...
        from billing.notifications import get_notifier
        ...
        self.entitlement_service = entitlement_service or container.get_entitlement_service()
        self.notification_service = (
            notification_service if notification_service is not None else get_notifier()
        )
    ...
    def _trigger_resync_after_recovery(self, subscription: Subscription) -> None:
        ...
        # still restricted and undoes its own trigger.
