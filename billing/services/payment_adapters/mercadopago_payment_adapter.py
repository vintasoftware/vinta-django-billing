...
from billing.services.mercadopago_signature import verify_mercadopago_signature
from billing.services.payment_adapters.base import BasePaymentAdapter, Payment, PaymentStatusUpdate
from billing.urls_helpers import namespaced
...
class MercadoPagoPaymentAdapter(BasePaymentAdapter):
    ...
    def check_refund_status(self, refund: Refund) -> str:
        ...
        logger.error(
            "Refund not found in provider's refund list: "
            "refund_external_id=%s payment_external_id=%s",
            refund.external_id,
