...
from billing.exceptions import OverLimitError
from billing.hierarchy import get_hierarchy, resolve_billing_root
...
from billing.services.billing_dataclasses import EffectiveLimit, LimitCheckResult
from billing.services.subscription_service import current_billing_period_start
...
class EntitlementService:
    ...
    Stateless; built by ``billing.services.container``. Read-only — nothing here
    ...
    def _get_pooled_organization_ids(self, root: Organization) -> list[int]:
        ...
        model. See :mod:`billing.hierarchy`.
