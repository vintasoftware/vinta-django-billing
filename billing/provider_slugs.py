...
Separate from :mod:`billing.constants` because a project may need to validate a
configured provider at settings-import time, and ``billing.constants`` cannot be
