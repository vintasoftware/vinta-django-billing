...
from vinta_billing.services.dataclasses import Payment, PaymentStatusUpdate, Refund, RefundResult
from vinta_billing.services.payment_adapters.base import BasePaymentAdapter
from vinta_billing.services.stripe_signature import verify_stripe_event
...
class StripePaymentAdapter(BasePaymentAdapter):
    ...
    #: `vinta_billing.services.stripe_signature.verify_stripe_event`.
