...
3. **Identity comes from the source, not from a second enumeration.**
   The project's :class:`~vinta_billing.metering.OccurrenceSource` is the one
...
from vinta_billing.services.entitlement_service import EntitlementService, metered_resource_key
...
class MeteringService:
    ...
    def expand_occurrence_identities(
        ...
        :class:`~vinta_billing.metering.OccurrenceSource`. What a "billable occurrence"
