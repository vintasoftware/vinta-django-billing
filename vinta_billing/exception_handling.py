...
Every error in :mod:`vinta_billing.exceptions` already knows its own machine-readable
...
Anything that is not a :class:`~vinta_billing.exceptions.BillingError` falls straight
...
out of the exception tree is what lets ``vinta_billing.exceptions`` stay importable
without DRF.
"""
